...
export const mostBoughtStocks: StockData[] = [
  {
    ...
    logoColor: "#1A73E8",
    logoInitial: "T",
    sparklineData: generateSparkline(13.6, 0.3, "down"),
  },
  {
    symbol: "RITES",
    companyName: "RITES",
    ...
    logoColor: "#E91E63",
    logoInitial: "R",
    sparklineData: generateSparkline(210, 8, "up"),
  },
  {
    symbol: "SAKSOFT",
    companyName: "Saksoft",
    ...
    logoColor: "#4CAF50",
    logoInitial: "S",
    sparklineData: generateSparkline(205, 5, "down"),
  },
  {
    symbol: "AVENUES",
    companyName: "AvenuesAI",
    price: 17.31,
    change: 0.82,
    changePercent: 4.97,
    isPositive: true,
    logoColor: "#FF9800",
    logoInitial: "A",
    sparklineData: generateSparkline(16.5, 0.5, "up"),
  },
];
